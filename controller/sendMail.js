    ...
    await smtpTransport.sendMail(
      {
        from: fromsendemail,
        to: email,
        subject: "RESET YOUR PASSWORD - Shoukosagiri RestAPI",
        html: `
    <!DOCTYPE html>
    <html>
    <head>
              ...
              <tr>
                <td align="center" valign="top" style="padding: 36px 24px;">
                  <a href="https://${domain}" target="_blank" style="display: inline-block;">
                    <img src="https://gravatar.com/userimage/130731616/72149cc31f595ec8ac1a64eb72c4201b.jpeg?size=256" alt="Logo" border="0" width="100" style="display: block; width: 100px; max-width: 100px; min-width: 100px; ">
                  </a>
                </td>
              </tr>
            </table>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
              ...
              <tr>
                <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-bottom: 3px solid #d4dadf">
                  <p style="margin: 0;">Shoukosagiri,<br> ${domain}</p>
                </td>
              </tr>
    ...
    await smtpTransport.sendMail(
      {
        from: fromsendemail,
        to: email,
        subject: "VERIFY YOUR EMAIL - Shoukosagiri RestAPI",
        html: `
    <!DOCTYPE html>
    <html>
    <head>
        ...
        <tr>
          <td align="center" bgcolor="#e9ecef">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
              ...
              <tr>
                <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                  <p style="margin: 0;">Thank you for using Shoukosagiri-API, Please press the button below to verify your account.</p>
                </td>
              </tr>
