...
$('.resetTag').click(function(e){
    e.preventDefault();
    $('.formBox').addClass('level-forget').removeClass('level-login');
});

$('.back').click(function(e){
    e.preventDefault();
    $('.formBox').removeClass('level-forget').addClass('level-req');
});
...
$('.regTag').click(function(e){
    ...
    $('.formBox').toggleClass('level-reg').toggleClass('level-login');
    if(!$('.formBox').hasClass('level-login')) {
        document.querySelector('.formBox').style.height = "110%";
        $('.formBox').removeClass('level-reg-revers');
    }
});
$('.btn').each(function() {
...
myInput.onkeyup = function() {
    ...
    if (document.querySelector('.pww').value ==
